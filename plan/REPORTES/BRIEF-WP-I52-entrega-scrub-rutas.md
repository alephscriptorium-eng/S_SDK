...
_SCRIPT_SDK `main` post-I41 ✅ · I27 ✅. Padre libre de workers vivos._
...
- I27 ✅ / I41 ✅ — sin solape de workers. Aun así: NO lanzar worker
  I52 de código — este WP no necesita rama de implementación.
...
- Lanzar worker I52: NUNCA para implementar en zeus.
  Solo eventual acta re-verif en plan/REPORTES/ tras merge zeus.

- CA (evidencia):
  1) Grep clase rutas absolutas locales en main zeus = 0.
  2) Re-verif vigía persistida (acta / VIGIA-ESTADO).
  3) Regla «entregas sin rutas» cosida en skill (I27 regla 12 ✅).

- Cadencia: CA abierto hasta (1)+(2). Orquestador marca ✅; no push
  zeus desde aquí.
- NO I50/I51 (sin GO). NO mutar submodules HOLONES/.
```

## Instrucción al padre

**NO lanzar worker I52.** I41 ✅ · I27 ✅ — no hay worker vivo que esperar.
I52 es entrega de custodio (§Nota), no obra de worker. Tras merge del
micro-WP en zeus → vigía re-verifica CA; entonces el padre puede pedir
acta `WP-I52-*-reverif.md` si hace falta.
