...
- [ ] Peercard (peer-card-seat) en bootstrap room-bridge del actor MCP.
- [ ] Wiring ciudad → player-mcp-kit intacto / verificado (reporte v2).
- [ ] Respuesta explícita v2/v3 en `WP-C05-ciudadano-agente.md`.
- [ ] Ceguera obra OK · no toca C01/C02/C03/C04 paths ajenos.

## Fuera

Z05 4–6 · §6 · trama-agua · E_SDK · reopen ✅ · despacho pre-R12.
