# 07 — SCRIPT_SDK (el método)

**Capa:** holárquica — el método que sostiene fragmentos sin metarrelato.
**Origen:** emergente — juntura 06↔07.
**Estado público:** activo (este repo).

## Estratos (cómo leer esta ficha)

| Estrato | Significado |
| ------- | ----------- |
| Verificado | Afirmación con fuente citada y comprobada |
| Asentado (DE-I8) | Anclaje preparado sin inflar submodule |
| `<pendiente>` | Declarado, no vendido como hecho |
| Roadmap | Placeholder ⬜ / 🔶 / ✅ — no es promesa |

## Lectura (doctrina)

Fuente: `DEVOPS/METODOLOGIA/holones/07-script-sdk.md`.

Relee 01–06 como capas del devops: cada holón pasa a tener pieza técnica
anclada (por puntero, no por copia — DS-5 / DE-I5). No almacena código de
los mundos. Composición desde el registry
`npm.scriptorium.escrivivir.co`, nunca inflando submodules ajenos ni
copiando árboles.

Juntura de entrada:
`DEVOPS/METODOLOGIA/holones/junturas/06-07-posmodernidad-metodo.md`.

Ceguera ascendente: no concibe qué vendrá después del método.
